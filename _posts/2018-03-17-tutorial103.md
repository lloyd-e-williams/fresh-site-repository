...
![Screen Shot 2018-03-05 at 7.59.50 AM](./Screen Shot 2018-03-05 at 7.59.50 AM.png)

- Choose the **Style: Template with Pattern: Map Data**

![Screen Shot 2018-03-05 at 8.02.54 AM](./Screen Shot 2018-03-05 at 8.02.54 AM.png)
...
![Screen Shot 2018-03-05 at 8.06.38 AM](./Screen Shot 2018-03-05 at 8.06.38 AM.png)

- Click the **Create** button.

The integration has been created.

- Click the **Save** button to save the work so far.

![Screen Shot 2018-03-05 at 8.09.23 AM](./Screen Shot 2018-03-05 at 8.09.23 AM.png)
...
![Screen Shot 2018-03-05 at 8.11.58 AM](./Screen Shot 2018-03-05 at 8.11.58 AM.png)

- Choose the `Local REST <your initials>` connection.

![Screen Shot 2018-03-05 at 8.15.03 AM](./Screen Shot 2018-03-05 at 8.15.03 AM.png)
...
![Screen Shot 2018-03-05 at 8.25.55 AM](./Screen Shot 2018-03-05 at 8.25.55 AM.png)

Based upon your selections the wizard will take you to the next configuration screen. You will only need to complete some of the configuration items listed down the left hand side of the wizard.
...
![Screen Shot 2018-03-05 at 8.33.38 AM](./Screen Shot 2018-03-05 at 8.33.38 AM.png)
...
![Screen Shot 2018-03-05 at 8.41.20 AM](./Screen Shot 2018-03-05 at 8.41.20 AM.png)
...
![Screen Shot 2018-03-05 at 8.46.13 AM](./Screen Shot 2018-03-05 at 8.46.13 AM.png)

- Click **Done**

The integration is not finished yet.
- Click on the **Save** button to save the work you have done so far.

![Screen Shot 2018-03-05 at 8.47.39 AM](./Screen Shot 2018-03-05 at 8.47.39 AM.png)
...
![Screen Shot 2018-03-05 at 8.51.41 AM](./Screen Shot 2018-03-05 at 8.51.41 AM.png)
...
![Screen Shot 2018-03-05 at 8.57.36 AM](./Screen Shot 2018-03-05 at 8.57.36 AM.png)
...
![Screen Shot 2018-03-05 at 9.15.07 AM](./Screen Shot 2018-03-05 at 9.15.07 AM.png)

- Then click the **Done** button.  

Notice that the integration updates and the percentage completion updates.
- Click the **Save** button.

![Screen Shot 2018-03-05 at 9.15.53 AM](./Screen Shot 2018-03-05 at 9.15.53 AM.png)
...
![Screen Shot 2018-03-05 at 9.18.27 AM](./Screen Shot 2018-03-05 at 9.18.27 AM.png)

A mapping wizard will appear.
- Drag from the `PersonId` in the source to the `PersonId` under `People/Person`.

![Screen Shot 2018-03-05 at 9.20.52 AM](./Screen Shot 2018-03-05 at 9.20.52 AM.png)

![Screen Shot 2018-03-05 at 9.22.33 AM](./Screen Shot 2018-03-05 at 9.22.33 AM.png)

- Do the same for the `Name` field.

![Screen Shot 2018-03-05 at 9.25.18 AM](./Screen Shot 2018-03-05 at 9.25.18 AM.png)

- Then click the **Validate** button.
- Then the **Close** button.

![Screen Shot 2018-03-05 at 9.26.59 AM](./Screen Shot 2018-03-05 at 9.26.59 AM.png)

- Click the **Save** button.
Notice the completion percentage is not yet at 100%. This is because we need to configure the tracking option.
- Choose the menu next to the Last Saved field.

![Screen Shot 2018-03-05 at 9.29.42 AM](./Screen Shot 2018-03-05 at 9.29.42 AM.png)

- Choose **Tracking**

![Screen Shot 2018-03-05 at 9.31.10 AM](./Screen Shot 2018-03-05 at 9.31.10 AM.png)
...
![Screen Shot 2018-03-05 at 9.32.09 AM](./Screen Shot 2018-03-05 at 9.32.09 AM.png)
...
![Screen Shot 2018-03-05 at 9.32.17 AM](./Screen Shot 2018-03-05 at 9.32.17 AM.png)

- Click **Save**

![Screen Shot 2018-03-05 at 9.36.33 AM](./Screen Shot 2018-03-05 at 9.36.33 AM.png)
...
![Screen Shot 2018-03-05 at 9.39.47 AM](./Screen Shot 2018-03-05 at 9.39.47 AM.png)
...
![Screen Shot 2018-03-05 at 10.05.45 AM](./Screen Shot 2018-03-05 at 10.05.45 AM.png)
...
![Screen Shot 2018-03-05 at 10.09.27 AM](./Screen Shot 2018-03-05 at 10.09.27 AM.png)

You will need to click on the **Refresh** icon to see if the integration has finished activating.

![Screen Shot 2018-03-05 at 10.10.54 AM](./Screen Shot 2018-03-05 at 10.10.54 AM.png)
...
![Screen Shot 2018-03-05 at 11.19.21 PM](./Screen Shot 2018-03-05 at 11.19.21 PM.png)



![Screen Shot 2018-03-05 at 10.13.21 AM](./Screen Shot 2018-03-05 at 10.13.21 AM.png) The integration is now ready to run. It's best to use a tool for testing REST interfaces (for example Postman or SOAP-UI) to test the interface. In this tutorial, we will use Postman which is available as a stand-alone install or a Chrome browser plug-in.
...
![Screen Shot 2018-03-05 at 10.33.46 AM](./Screen Shot 2018-03-05 at 10.33.46 AM.png)
...
![Screen Shot 2018-03-05 at 10.36.18 AM](./Screen Shot 2018-03-05 at 10.36.18 AM.png)



Notice that `Authorization` and `Content-Type` Headers were generated automatically. You do not need to adjust these values.

![Screen Shot 2018-03-05 at 10.40.05 AM](./Screen Shot 2018-03-05 at 10.40.05 AM.png)
...
![Screen Shot 2018-03-05 at 10.42.48 AM](./Screen Shot 2018-03-05 at 10.42.48 AM.png)



Ask your instructor to check and see if your file was created on the computer running the agent.

![Screen Shot 2018-03-05 at 10.30.37 AM](./Screen Shot 2018-03-05 at 10.30.37 AM.png)
...
![Screen Shot 2018-03-05 at 10.50.26 AM](./Screen Shot 2018-03-05 at 10.50.26 AM.png)



![Screen Shot 2018-03-05 at 10.57.15 AM](./Screen Shot 2018-03-05 at 10.57.15 AM.png)
...
![Screen Shot 2018-03-05 at 10.53.45 AM](./Screen Shot 2018-03-05 at 10.53.45 AM.png)
...
Before you continue creating more integrations, you should understand [monitoring](/oic/tutorial104/).
